  ...
  return (
    <main className="min-h-screen bg-white text-gray-800 p-6">
      ...
      <p className="text-red-600 mb-6">
        Here are all your saved jobs and scholarships.
      </p>
      ...
      <section>
        ...
        {favScholarships.length === 0 && (
          <p className="text-yellow-500">No saved scholarships yet. Go to Scholarships and save some!</p>
        )}
        <ul className="space-y-4">
          {favScholarships.map((sch) => (
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block mt-3 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold"
              >
                🔗 View Details
              </a>
              <button
                onClick={() => removeScholarship(sch.id)}
                className="ml-3 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-semibold"
              >
                ❌ Remove
              </button>
            </li>
